...
class LP_Project(models.Model):
    ...
    lp_budget = fields.Char('Budget', readonly=True, tracking=True, copy=False, groups="lp_security.director_group,lp_security.department_head_group")
    allowed_portal_user_ids = fields.Many2many('res.users', 'project_allowed_portal_users_rel',
                                               string="Project Team", domain=[('share', '=', True)])
    date_start = fields.Date(readonly=True, tracking=True, copy=False, groups="lp_security.director_group,lp_security.department_head_group")
    lp_date_end = fields.Date('End Date', readonly=True, tracking=True, copy=False, groups="lp_security.director_group,lp_security.department_head_group")
    ...
    lp_proposed_budget = fields.Char('Proposed Budget', tracking=True, copy=False, groups="lp_security.director_group,lp_security.department_head_group")
    lp_proposed_date_start = fields.Date('Proposed Start Date', tracking=True, copy=False, groups="lp_security.director_group,lp_security.department_head_group")
    lp_proposed_date_end = fields.Date('Proposed End Date', tracking=True, copy=False, groups="lp_security.director_group,lp_security.department_head_group")
